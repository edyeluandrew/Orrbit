...
// Default services with placeholder wallet addresses
const DEFAULT_SERVICES = [
  { id: 1, name: 'GPT Pro', type: 'AI', amount: 20, walletAddress: '', color: 'emerald', active: true },
  { id: 2, name: 'Claude', type: 'AI', amount: 18, walletAddress: '', color: 'purple', active: true },
  { id: 3, name: 'Namecheap', type: 'Domain', amount: 5, walletAddress: '', color: 'orange', active: true },
  { id: 4, name: 'GoDaddy', type: 'Hosting', amount: 10, walletAddress: '', color: 'blue', active: true },
  { id: 5, name: 'Spotify', type: 'Music', amount: 7, walletAddress: '', color: 'green', active: true },
  { id: 6, name: 'Netflix', type: 'Video', amount: 12, walletAddress: '', color: 'red', active: true },
];
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-orbit-gray text-sm mt-1">
            Manage services and their wallet addresses • {PLATFORM_FEE_PERCENT}% platform fee
          </p>
        </div>
        <button
      ...
      {showAddForm && (
        <div className="bg-[#14141A] border border-orbit-gold/30 rounded-xl p-6">
          <h3 className="text-white font-display font-bold mb-4">Add New Service</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <input
              type="text"
              placeholder="Type (AI, Hosting, etc.)"
